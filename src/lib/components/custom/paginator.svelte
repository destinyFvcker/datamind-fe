...
<div class="@container">
	<div
		class="flex flex-col items-start justify-between overflow-auto px-2 [scrollbar-width:none] @xl:flex-row @xl:items-center"
	>
		<div class="flex items-center gap-2">
			<span class="font-bold text-nowrap">{`查找${itemName}代码:`}</span>
			<div class="relative">
				<Search
		...
		<span class="min-w-2"> </span>
		<div class="flex items-center gap-1 lg:space-x-8">
			<div class="flex items-center space-x-2">
				<p class="hidden min-w-[98px] text-sm font-medium @xl:inline">Rows per page</p>
				<Select.Root
					type="single"
